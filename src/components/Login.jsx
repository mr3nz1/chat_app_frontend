    ...
    return (
        <>
            <div className="w-full flex justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center space-y-2 mt-4 md:mt-0 w-full">
                    <div className="flex flex-col space-y-4 border border-gray-200 rounded-sm p-4 sm:w-96">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col space-y-2">
                            <input name="usernameOrEmail" onChange={handleChange} type="text" placeholder='Izina ukoresha cyangwa email ukoresha' className='px-4 py-3 rounded-sm bg-gray-100 text-xs border border-gray-200 outline-none focus:border-0 focus:border-l-4 focus:border-blue-500 transition-all duration-300' required />
                    ...
                    <div className="border border-gray-200 rounded-sm p-4 sm:w-96 text-xs">
                        <p>Nta konti ufite? <Link to="/register" className='text-blue-500'>Kora indi</Link></p>
                    </div>
